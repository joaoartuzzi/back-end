    ...
    public class PaisController : Controller
    {
        ...
        public IActionResult Index(string botao, string? txtFiltro, string selOrdenacao, int pagina = 1)
        {
            ...
            if (txtFiltro != null && txtFiltro != "")
            {
                ...
                lista = lista.Where(item => item.Nome.ToLower().Contains(txtFiltro.ToLower()) || item.Capital.ToLower().Contains(txtFiltro.ToLower()));
            }
            ...
            else if (selOrdenacao == "PopulacaoMenor")
            {
